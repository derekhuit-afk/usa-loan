...
export const post: Post = {
  slug: "wshfc-dpa-stacking-guide-washington-2026",
  title: "WSHFC Down Payment Assistance in Washington 2026: How to Stack State, City, and VA Programs",
  description:
  ...
  states: ["washington"],
  cluster: "Washington first-time buyer",
  readMinutes: 11,
  keywords: {
    primary: "WSHFC down payment assistance Washington 2026",
    secondary: [
      "Washington first time home buyer programs 2026",
      "WSHFC Home Advantage DPA",
      "Washington state DPA VA loan stack",
      "Seattle down payment assistance 2026",
      "WSHFC veterans DPA Washington",
    ],
    longtail: [
      "can I stack WSHFC with a VA loan in Washington",
      "WSHFC Home Advantage income limit 2026 King County",
      "Washington first time buyer programs military exempt",
      "Seattle Office of Housing DPA how to qualify",
      "WSHFC homebuyer education course requirement 2026",
    ],
  },
  hook: [
  ...
  sections: [
    {
      heading: "WSHFC Home Advantage: the foundation of every Washington DPA stack",
      paragraphs: [
        ...
        "Income limits for Home Advantage in 2026 reach up to $180,000 for King and Snohomish County buyers and vary by county and household size across the state. Purchase price limits range from approximately $345,000 to $750,000 depending on county and loan type, with a maximum loan amount of $806,500. These limits are updated annually — verify current figures with a WSHFC-approved lender before structuring a purchase around them.",
    ...
    {
      heading: "Home Advantage DPA: the 0% deferred second mortgage",
      paragraphs: [
    ...
    {
      heading: "VA plus WSHFC: the most powerful stack for military Washington buyers",
      paragraphs: [
    ...
    {
      heading: "Seattle Office of Housing: the city layer that most buyers miss",
      paragraphs: [
    ...
    {
      heading: "Tacoma, Clark County, and other local programs",
      paragraphs: [
    ...
    {
      heading: "What the lender experience actually matters",
      paragraphs: [
  ...
  related: [
    ...
    { label: "VA loans at JBLM and Washington military bases", href: "/learn/jblm-va-loan-guide-washington-2026" },
