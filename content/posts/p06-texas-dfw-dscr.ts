...
export const post: Post = {
  slug: "dallas-fort-worth-dscr-loan-investor-guide-2026",
  title: "Dallas-Fort Worth DSCR Loan Guide 2026: Which DFW Suburbs Still Pencil for Investors",
  description:
    "DFW is ranked the number one real estate investment market in the US for 2026. But not every neighborhood produces standard DSCR qualification — and Texas property taxes are the number that most out-of-state investors underestimate. This guide covers which submarkets cash flow, which compress, and how to structure a DSCR deal in DFW that survives underwriting.",
  ...
  readMinutes: 11,
  keywords: {
    primary: "DSCR loan Dallas Fort Worth 2026",
    secondary: [
      "DFW investment property DSCR loan Texas",
      "Dallas DSCR investor guide 2026",
      "Fort Worth rental property DSCR financing",
      "DFW cash flow investment property 2026",
      "Texas DSCR loan no income verification",
    ],
    longtail: [
      "which DFW neighborhoods produce 1.0 DSCR 2026",
      "Dallas property tax impact on DSCR ratio",
      "Mesquite Garland Grand Prairie DSCR investor guide",
      "DFW self-employed investor DSCR loan no W2",
      "how to structure DSCR deal Texas 2026",
    ],
  },
  hook: [
  ...
  sections: [
    {
      heading: "Why DFW is the most active DSCR market in the Sun Belt",
      paragraphs: [
    ...
    {
      heading: "The DFW DSCR submarket map: where deals work and where they don't",
      paragraphs: [
    ...
    {
      heading: "Texas property taxes: the number that kills DFW deals",
      paragraphs: [
    ...
    {
      heading: "How DSCR qualification works in Texas",
      paragraphs: [
  ...
  faq: [
    {
      q: "What credit score do I need for a Texas DSCR loan?",
      a: "Most standard Texas DSCR programs require a minimum credit score of 640. Pricing improves at 680 and again at 720. Programs that allow DSCR ratios below 1.0 typically require higher credit scores — 700 or above is common for sub-1.0 programs. The minimum loan amount for most DSCR programs is $150,000.",
    },
    {
      q: "How do Texas property taxes affect my DSCR ratio?",
      a: "Directly. Property taxes are included in PITIA — the denominator of the DSCR calculation. At DFW's typical 2.0 percent effective tax rate, a $300,000 property adds approximately $500 to the denominator each month. Always use the non-homestead tax rate — investment properties do not qualify for Texas's homestead exemption. Get the actual county appraisal district assessed value before running your numbers.",
    },
    {
      q: "Can I buy a Texas DSCR property in an LLC?",
      a: "Yes. DSCR loans are available to individuals and to LLCs, partnerships, and other entities. Most investors acquiring Texas rental portfolios prefer LLC vesting for liability separation. Standard entity documentation is required at closing: operating agreement, EIN, formation documents, and the lender's entity questionnaire. Some lenders have seasoning requirements for newly formed entities — confirm before structuring.",
    },
    {
      q: "What happens if the appraiser's rent schedule comes in below my projection?",
      a: "Your DSCR ratio drops below the projection and may fall below the program minimum. If the ratio falls below 1.0 on a standard program, you may need to bring additional cash to reduce the loan amount, accept a different program with a higher rate, or exit the contract if your inspection period allows. Run a 10 percent downside rent scenario in your initial pro forma so you know the deal's floor before contracting.",
    },
    {
      q: "Is Derek Huit licensed to originate DSCR loans in Texas?",
      a: "Yes. Derek Huit, NMLS #203980, holds a Texas-SML Mortgage Loan Originator license and originates DSCR investment property loans in Texas. Cardinal Financial Company, Limited Partnership, NMLS #66247, is the lender. Both can be verified at NMLS Consumer Access.",
    },
  ],
  related: [
