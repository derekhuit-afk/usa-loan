...
export const post: Post = {
  slug: "jacksonville-dscr-loan-investor-guide-2026",
  title: "Jacksonville DSCR Loan Guide 2026: Florida's Most Consistent Cash-Flow Market",
  description:
    "Jacksonville produces the most predictable DSCR ratios of any major Florida market. Median home prices around $283K, median asking rent at $2,000, NAS Jacksonville and Mayport anchoring the tenant base. Here is how DSCR qualification works in this market and which submarkets actually pencil.",
  publishDate: "2026-07-21",
  states: ["florida"],
  cluster: "DSCR investor",
  readMinutes: 12,
  keywords: {
    primary: "Jacksonville DSCR loan 2026",
    secondary: [
      "DSCR loan Jacksonville Florida",
      "investment property loan Jacksonville",
      "Jacksonville rental property financing",
      "Florida DSCR investor loan no income",
      "NAS Jacksonville rental property DSCR",
    ],
    longtail: [
      "how does DSCR loan work Jacksonville Florida",
      "best Jacksonville neighborhoods for DSCR cash flow 2026",
      "qualify investment property loan without tax returns Florida",
      "Jacksonville vs Tampa DSCR loan comparison",
      "NAS Jacksonville Mayport rental property investor loan",
    ],
  },
  hook: [
  ...
  sections: [
    {
      heading: "Why Jacksonville DSCR ratios outperform the rest of Florida",
      paragraphs: [
    ...
    {
      heading: "NAS Jacksonville and Mayport: why military demand matters for investors",
      paragraphs: [
    ...
    {
      heading: "Jacksonville submarket breakdown: where the DSCR math works",
      paragraphs: [
    ...
    {
      heading: "Florida insurance: the DSCR factor most investors underestimate",
      paragraphs: [
    ...
    {
      heading: "DSCR qualification in Jacksonville: what the file actually needs",
      paragraphs: [
    ...
    {
      heading: "No conventional loan count ceiling: why DSCR matters for portfolio builders",
      paragraphs: [
  ...
  comparison: {
    heading: "Jacksonville vs. Tampa vs. Miami: DSCR math at 80% LTV",
    intro:
    ...
    columns: ["Jacksonville (Mandarin)", "Tampa Bay / Miami"],
    rows: [
  ...
  faq: [
    {
      q: "What is a DSCR loan and can I use one for a Jacksonville rental property?",
    ...
    {
      q: "What DSCR ratio do I need to qualify in Jacksonville?",
      a: "Most standard programs require a minimum 1.0 DSCR — meaning projected rent covers the full monthly housing obligation including principal, interest, taxes, insurance, and HOA. Some programs accept ratios as low as 0.75 with compensating factors such as a higher credit score or lower LTV. In Mandarin and Baymeadows, well-selected properties routinely produce ratios above 1.10 at 80 percent LTV.",
    },
    {
      q: "Do I need a signed lease to get a DSCR loan for a vacant Jacksonville property?",
      a: "No. For vacant properties, the appraiser completes a rent schedule establishing market rent for that property type and location. That figure is used in the DSCR calculation in place of an existing lease. You can close a DSCR loan on a vacant property without a tenant in place.",
    },
    {
      q: "Why does Florida insurance affect my DSCR approval?",
      a: "Insurance is factored into the housing obligation used to calculate your DSCR ratio. In Jacksonville, landlord policies in Jacksonville typically run $1,800 to $3,500 annually depending on construction type, roof age, and location. An inaccurate insurance estimate built into your initial pro forma can cause the deal to fail underwriting after the actual cost is factored in. Get a real quote for the specific property before submitting the DSCR application.",
    },
    {
      q: "Can I buy a Jacksonville rental property in an LLC with a DSCR loan?",
      a: "Yes. DSCR loans are available to individuals and to LLCs, partnerships, and other entities. Many investors hold Florida rentals in an LLC for liability protection. Standard entity documents — articles of organization, operating agreement, EIN — are required. The loan is still underwritten on the property's rental income regardless of entity structure.",
    },
    {
      q: "Is there a limit to how many DSCR loans I can have?",
      a: "No. DSCR loans operate outside the Fannie Mae ten-property conventional ceiling. An investor with twelve existing rentals can add a thirteenth on DSCR financing without the portfolio count affecting qualification. This is the primary structural reason portfolio builders use DSCR financing for scale.",
    },
    {
      q: "Is Derek Huit licensed to originate investment property loans in Florida?",
      a: "Yes. Derek Huit, NMLS #203980, is licensed to originate mortgage loans in Florida. Cardinal Financial Company, Limited Partnership, NMLS #66247, is the lender. DSCR and investment property financing is available through this channel for eligible Florida properties.",
    },
  ],
  related: [
    ...
    { label: "Florida mortgage guides", href: "/learn" },
