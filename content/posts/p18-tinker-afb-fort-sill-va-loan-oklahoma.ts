...
export const post: Post = {
  slug: "tinker-afb-fort-sill-va-loan-guide-oklahoma-2026",
  ...
  keywords: {
    ...
    secondary: [
      "Tinker AFB VA home loan",
      "Fort Sill VA loan Lawton Oklahoma",
      "Altus AFB VA loan southwest Oklahoma",
      "Oklahoma City VA home purchase 2026",
      "Oklahoma veteran property tax exemption",
    ],
    longtail: [
      "buying a home near Tinker AFB Midwest City Oklahoma",
      "Fort Sill Lawton VA loan BAH 2026",
      "Oklahoma VA loan no down payment no military income tax",
      "Tinker AFB Del City Choctaw Harrah VA home purchase options",
      "Oklahoma 100 percent disabled veteran property tax exemption",
    ],
  },
  hook: [
  ...
  comparison: {
    heading: "Oklahoma installation comparison: BAH and market pricing",
    intro:
      "Oklahoma's three installations serve different military communities at different price points. VA entitlement performs at all three — Lawton and Altus offer the strongest coverage ratios.",
    columns: ["E-5 BAH w/dep (2026)", "Median home price / Notes"],
    rows: [
      ["Tinker AFB / Oklahoma City", "$1,512/mo", "~$212K metro median · Most inventory"],
      ["Fort Sill / Lawton", "$1,134/mo", "~$165K · Strongest BAH coverage ratio"],
      ["Altus AFB / Altus", "$1,134/mo", "~$130K · Lowest prices in the state"],
      ["Oklahoma City suburbs (Moore/Edmond)", "$1,512/mo", "$230K–$350K · Schools premium"],
    ],
  },
  faq: [
    {
      q: "Does Oklahoma tax military retirement pay?",
      a: "No. Oklahoma exempts all military retirement pay from state income tax. This applies to retired pay from all uniformed services — Army, Navy, Air Force, Marine Corps, Coast Guard, and Space Force. It also applies to Survivor Benefit Plan (SBP) payments received by surviving spouses. The exemption is automatic — Oklahoma resident military retirees do not need to file a special form to claim it.",
    },
    {
      q: "What is Oklahoma's property tax exemption for disabled veterans?",
      a: "Oklahoma provides a full property tax exemption on the primary residence for veterans who are rated 100 percent permanently and totally disabled by the VA. The veteran must have received an honorable discharge and must own and occupy the property as a primary residence. The exemption is applied to the entire assessed value of the property, eliminating property tax completely. Applications are filed with the county assessor.",
    },
    {
      q: "Can I buy a home in Oklahoma City while stationed at Tinker on a PCS?",
      a: "Yes. VA financing works for any qualifying purchase in the Tinker-area housing market. Active-duty personnel on PCS orders who intend to occupy the property as their primary residence qualify for VA financing. The loan closes, you move in, and the VA loan remains in effect for the duration of your ownership — including if you PCS again before selling, in which case the property can become a rental while your VA loan remains in place.",
    },
    {
  ...
  related: [
    ...
    { label: "DSCR opportunities in Oklahoma City", href: "/learn/oklahoma-city-dscr-loan-investor-guide-2026" },
