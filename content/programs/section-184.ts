...
export const program: Program = {
  ...
  sections: [
    {
      heading: "What Section 184 is and who it serves",
      paragraphs: [
    ...
    {
      heading: "The cost structure: where Section 184 beats other government programs",
      paragraphs: [
    ...
    {
      heading: "Underwriting: manual by design",
      paragraphs: [
  ...
  requirements: [
    { label: "Down payment", value: "2.25 percent of purchase price (gifts and tribal DPA permitted)" },
    { label: "Upfront guarantee fee", value: "1 percent, may be financed into the loan" },
    { label: "Annual fee / monthly MI", value: "None (annual fee eliminated July 2023)" },
    { label: "Eligibility", value: "Enrolled member of a federally recognized tribe or Alaska Native village" },
    { label: "Underwriting", value: "Manual — no fixed minimum credit score; DTI 41 percent (43 with compensating factors)" },
    { label: "Loan type", value: "Fixed-rate only, up to 30 years; no ARMs" },
    { label: "Property", value: "1–4 unit primary residence; trust, allotted, or fee simple land" },
    { label: "Loan limit", value: "Up to 150 percent of the county FHA limit — verify current county figures" },
  ],
  faq: [
    {
      q: "Do I have to live on tribal land to use Section 184?",
      a: "No. The property must be located in an eligible area, but eligible areas extend far beyond tribal trust land — in Oklahoma, every county in the state qualifies. Enrolled members buying standard fee simple homes in Oklahoma City, Tulsa, or anywhere else in the state can use the program.",
    },
    {
      q: "Is there a minimum credit score for Section 184?",
      a: "The program sets no fixed minimum score. Every loan is manually underwritten, and the standard is overall creditworthiness — underwriters can consider alternative credit and the circumstances behind past late payments. Individual lenders may apply their own overlays, so a borrower declined at one 184 lender is not necessarily declined everywhere.",
    },
    {
      q: "Can Section 184 be used to refinance?",
      a: "Yes. The program supports refinancing an existing mortgage, including streamline options for existing Section 184 loans. It can also finance new construction and rehabilitation, not just purchases.",
    },
    {
      q: "Is Derek Huit licensed in Oklahoma and approved to originate Section 184 loans?",
      a: "Yes. Derek Huit, NMLS #203980, holds an Oklahoma Mortgage Loan Originator License. Cardinal Financial Company, Limited Partnership, NMLS #66247, is the lender and appears on HUD's current Section 184 lender participation list with approval to originate Section 184 loans in Oklahoma. Both licenses can be verified at NMLS Consumer Access.",
    },
  ],
  related: [
    { label: "Oklahoma Section 184 complete guide", href: "/learn/oklahoma-hud-section-184-home-loan-guide-2026" },
    { label: "Section 184 vs FHA vs VA comparison", href: "/learn/section-184-vs-fha-vs-va-oklahoma-tribal-members-2026" },
