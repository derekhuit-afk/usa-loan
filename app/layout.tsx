...
const LO_STATES = ['Alaska', 'Georgia', 'Illinois', 'Indiana', 'Michigan', 'Montana', 'Oklahoma', 'Texas', 'Washington'];
  ...
  '@graph': [
    {
      ...
      url: 'https://usa.loan',
      description:
        'Direct mortgage lending from Derek Huit, NMLS #203980, personally licensed in 9 states. Loans originated through Cardinal Financial Company, Limited Partnership, NMLS #66247.',
